function [IQ,Fc,newFs] = rf2iqFnkWave(RF,Fs,Fc,B)
...
%---Added by Mahesh to resample the dataset
%IQ = resample(IQ,1,floor(double(Fs)/double(1.2*Fc))); %Assuming a half-bandwidth of 1.2xFc 
newFs=Fs;%/(floor(double(Fs)/double(1.2*Fc)));
