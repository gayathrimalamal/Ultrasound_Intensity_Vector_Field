...
function [scat_mat, scat_mat_apod,receive_apodization] = scatter_mat_pixel_RF(acq,rawData,timeVector,focal_delay,x_grid,z_grid,probe_geometry,ang,c_map, Fnum)
...
for nrx=1:N_elements
    ...
    scat_mat(:,nrx) = interp1(timeVector+focal_delay(nrx),rawData(:,nrx),delay,'spline',0);
