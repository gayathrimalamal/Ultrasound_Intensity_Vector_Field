%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Specular Line- Specular Reflector Model Model-L11-5v- Plane Wave Transmission
%  Date 22-10-2021
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc;
clear all;
...
lineLen = 200;%200; %Length of the line
...
for Nc = 1: Trans.tx_N_elements
    karray.addRectElement([kgrid.x_vec(170), probe_geometry(Nc, 1)],100e-6, Trans.tx_element_width, rotation);
end
...
display_mask=source.p_mask+medium.sound_speed/norm(medium.sound_speed);
display_mask=histeq(display_mask);
display_mask(display_mask<0.5)=0;
display_mask(display_mask>0.5)=1;
